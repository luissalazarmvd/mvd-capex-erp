...
- La ficha complementaria corresponde a un único activo a la vez. Al hacer clic en cualquier parte de una fila se focaliza/abre su ficha y la fila queda sombreada en azul; repetir el clic en la misma fila la cierra. Enfocar o editar cualquiera de sus celdas editables fuerza la apertura de la ficha, incluso si ya estaba focalizada. No usar checks ni selección múltiple. El hint de COD se muestra dentro de la ficha activa y refleja el COD de esa fila, incluyendo el último correlativo del catálogo y el siguiente obligatorio.
