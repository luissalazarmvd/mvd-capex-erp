...
const fleetPerformanceFields = (): VaiField[] => [
  ...
  f("qty_usd", "Galones con costo USD", "measure", "Galones de vales reconocidos como USD.", "number", "gal"),
  ...
  f("cost_usd_known", "Costo identificado USD", "measure", "Subtotal diario de importes reconocidos como USD.", "number", "usd"),
  ...
  f("excess_usd_known", "Exceso identificado USD", "measure", "Costo identificado USD del exceso.", "number", "usd"),
  f("unpriced_anomaly_count", "Anomalías sin valorización", "measure", "Anomalías cuyo exceso no pudo valorizarse en PEN ni USD.", "number", "integer"),
  f("tank_capacity", "Capacidad de tanque", "attribute", "Capacidad vigente en galones; no se suma.", "number", "gal"),
  ...
  f("unit_price_usd_known", "Precio USD por galón", "attribute", "Costo USD identificado / galones USD del día; para consolidar usar la métrica correspondiente.", "number", "usd_per_gal"),
  ...
  f("cost_per_km_usd_known", "Costo USD por km", "attribute", "Costo USD identificado / km del día; para períodos usar la métrica correspondiente.", "number", "usd_per_km"),
];
...
const fleetPerformanceMetrics = (): VaiMetric[] => [
  ...
  m("cost_usd_known", "Costo identificado USD", "Suma de importes reconocidos como USD.", "sum", "usd", { field: "cost_usd_known" }),
  ...
  m("avg_cost_usd_per_gal", "Costo promedio por galón USD", "Σ costo USD identificado / Σ galones de vales USD.", "ratio", "usd_per_gal", { numerator: "cost_usd_known", denominator: "qty_usd" }),
  ...
  m("cost_per_km_usd", "Costo USD por km", "Σ costo USD identificado / Σ km para vehículos con ficha útil.", "ratio", "usd_per_km", { numerator: "cost_usd_known", denominator: "odometer_km", where: [{ field: "is_vehicle", op: "eq", value: "true" }] }),
  ...
  m("excess_usd_known", "Exceso identificado USD", "Costo USD identificado del exceso.", "sum", "usd", { field: "excess_usd_known" }),
...
const fleetPerformanceSource = (): VaiSource => ({
  ...
  area: "fleet",
  description: "Cruce diario por placa entre GPS y combustible, preparado para recalcular correctamente rendimiento, consumo y costos en cualquier período.",
  endpoint: "/api/vai/fleet/performance",
  sqlView: "dw.v_dit_vai_flota_rendimiento",
  ...
  rules: [
    ...
    "PEN y USD permanecen separados. No convertir ni mezclar monedas.",
...
export const VAI_SOURCES: VaiSource[] = [
  ...
  // ── Trazabilidad ──────────────────────────────────────────────────────
  {
    ...
    area: "traceability",
    description:
      "Lotes de mineral comprados a mineros y proveedores desde 2026: oficina y zona de acopio, tonelaje, leyes de oro y plata, onzas, valorización (PIO, maquila, USD/TMS), clasificación programa/adicional, factura y pago.",
    ...
    relations: [
      ...
      { field: "lot", source: "traceability_payments", targetField: "lot", description: "Lote → pago contable." },
    ],
    keywords: ["mineral", "lote", "lotes", "minero", "proveedor", "ley", "leyes", "oro", "plata", "au", "ag", "onzas", "tms", "tmh", "concesión", "trazabilidad", "ingreso", "compra", "factura", "pago", "pio", "maquila", "humedad", "oficina", "sede", "zona", "programa", "adicional", "acopio"],
    enabled: true,
  ...
  },
  {
    ...
    area: "traceability",
    description:
      "Lotes de mineral contabilizados: fecha de pago, oficina normalizada, clasificación programa/adicional, factura, moneda, TMS, ley Au e importe USD por lote. Es la base del cumplimiento de metas por oficina.",
    endpoint: "/api/vai/traceability/payments",
    sqlView: "dw.v_traceability_conta_get",
    grain: "Una fila por lote contabilizado (voucher de pago).",
    query: q(["payment_date", "invoice_doc_date", "invoice_reg_date", "entry_date"], ["office_name", "sede", "ruc", "supplier", "currency", "program_class", "department"]),
    fields: [
      f("lot", "Lote", "attribute", "Código del lote."),
      ...
      f("invoice_reg_date", "Fecha de registro", "date", "Fecha de registro contable de la factura.", "date", "date", ["registro", "registrado"]),
      f("entry_date", "Fecha de ingreso", "date", "Ingreso del lote.", "date", "date", ["ingresado", "ingresados", "ingreso"]),
      f("office_name", "Oficina", "dimension", "Oficina de acopio normalizada (JULIACA se reporta como PEDREGAL)."),
      f("sede", "Sede contable", "dimension", "Sede tal como aparece en contabilidad."),
      f("program_class", "Programa / adicional", "dimension", "PROGRAMA o ADICIONAL según Control de Mineral o ley Au ≤ 0.2 oz/TC."),
      f("supplier", "Proveedor", "dimension", "Proveedor pagado."),
      f("ruc", "RUC", "attribute", "RUC del proveedor."),
      f("currency", "Moneda", "dimension", "Moneda del documento."),
      f("doc_type", "Tipo de documento", "dimension", "Tipo de comprobante."),
      f("doc_number", "Documento", "attribute", "Número de factura."),
      f("voucher_number", "Comprobante de pago", "attribute", "Número de comprobante contable del pago."),
      f("concession_name", "Concesión", "dimension", "Concesión de origen."),
      f("department", "Departamento", "dimension", "Departamento de origen."),
      f("province", "Provincia", "dimension", "Provincia de origen."),
      f("transport_name", "Transportista", "dimension", "Transportista del lote."),
      f("tmh", "TMH", "measure", "Toneladas húmedas del lote.", "number", "tmh"),
      f("tms", "TMS", "measure", "Toneladas secas del lote.", "number", "tms"),
      f("au_grade_oztc", "Ley Au (oz/TC)", "measure", "Ley de oro.", "number", "grade_oztc"),
      f("lot_usd", "USD contabilizado", "measure", "Importe USD del lote.", "number", "usd"),
    ],
    metrics: [
      m("payments_count", "Lotes pagados", "Número de filas lote-pago.", "count", "integer"),
      m("lots_count", "Lotes", "Lotes distintos.", "count_distinct", "integer", { field: "lot" }),
      m("lot_usd_total", "USD contabilizado", "Suma de importes contabilizados.", "sum", "usd", { field: "lot_usd" }),
      m("tms_total", "TMS", "Suma de TMS pagadas.", "sum", "tms", { field: "tms" }),
      m("tmh_total", "TMH", "Suma de TMH pagadas.", "sum", "tmh", { field: "tmh" }),
      m("suppliers_count", "Proveedores", "Proveedores distintos.", "count_distinct", "integer", { field: "ruc" }),
      m("avg_au_grade", "Ley Au promedio", "Ley de oro ponderada por TMS.", "weighted_avg", "grade_oztc", { field: "au_grade_oztc", weight: "tms" }),
      m("usd_per_tms", "USD/TMS", "USD contabilizado dividido entre TMS.", "ratio", "usd", { numerator: "lot_usd", denominator: "tms", where: [{ field: "tms", op: "gt", value: 0 }] }),
      m("lot_usd_program", "USD programa", "USD de lotes PROGRAMA.", "sum", "usd", { field: "lot_usd", where: [{ field: "program_class", op: "eq", value: "PROGRAMA" }] }),
      m("lot_usd_additional", "USD adicional", "USD de lotes ADICIONAL.", "sum", "usd", { field: "lot_usd", where: [{ field: "program_class", op: "eq", value: "ADICIONAL" }] }),
      m("tms_program", "TMS programa", "TMS de lotes PROGRAMA.", "sum", "tms", { field: "tms", where: [{ field: "program_class", op: "eq", value: "PROGRAMA" }] }),
      m("tms_additional", "TMS adicional", "TMS de lotes ADICIONAL.", "sum", "tms", { field: "tms", where: [{ field: "program_class", op: "eq", value: "ADICIONAL" }] }),
      m("avg_days_entry_to_payment", "Días ingreso → pago", "Promedio de días calendario entre ingreso y pago.", "avg_days_diff", "days", { field: "entry_date", field2: "payment_date" }),
    ],
    rules: [
      "Incluye lotes con ingreso desde 2026 y lotes 2025 pagados en 2026.",
      "lot_usd es el importe contabilizado del lote; para comparar con metas agrupar por office_name y mes de payment_date contra traceability_targets.",
      "Un lote puede tener más de un voucher: contar lotes con lots_count.",
    ],
    defaultDateField: "payment_date",
    relations: [{ field: "office_name", source: "traceability_targets", targetField: "office_name", description: "Pagos → metas mensuales por oficina." }],
    keywords: ["pago", "pagos", "contabilidad", "voucher", "oficina", "proveedor", "usd", "trazabilidad", "programa", "adicional", "meta", "cumplimiento"],
    enabled: true,
    access: { scopes: ["traceability"] },
  },
  {
    id: "traceability_payment_vouchers",
    name: "Comprobantes de pago a proveedores de mineral",
    area: "traceability",
    description:
      "Provisiones y pagos contables a proveedores de mineral por comprobante: oficina, proveedor, documento, moneda, importe provisionado y pago efectivo en USD. No es por lote.",
    endpoint: "/api/vai/traceability/payment-vouchers",
    sqlView: "dw.v_traceability_conta_payments_get",
    grain: "Una fila por provisión + comprobante de pago.",
    query: q(["payment_date", "provision_date", "document_date"], ["office_name", "sede", "ruc", "supplier", "provision_currency", "payment_currency", "source_year"]),
    fields: [
      f("source_year", "Año fuente", "dimension", "Año contable de origen del comprobante."),
      f("payment_date", "Fecha de pago", "date", "Fecha del comprobante de pago.", "date", "date", ["pago", "pagado", "pagos"]),
      f("provision_date", "Fecha de provisión", "date", "Fecha del comprobante de provisión.", "date", "date", ["provisión", "provision", "provisionado"]),
      f("document_date", "Fecha de documento", "date", "Fecha de la factura del proveedor.", "date", "date", ["factura", "documento"]),
      f("office_name", "Oficina", "dimension", "Oficina normalizada."),
      f("sede", "Sede contable", "dimension", "Sede original."),
      f("supplier", "Proveedor", "dimension", "Proveedor pagado."),
      f("ruc", "RUC", "attribute", "RUC del proveedor."),
      f("document_type", "Tipo de documento", "dimension", "Tipo de comprobante provisionado."),
      f("document_number", "Documento", "attribute", "Número de documento provisionado."),
      f("provision_currency", "Moneda de provisión", "dimension", "Moneda del importe provisionado."),
      f("provision_amount", "Importe provisionado", "measure", "Importe en la moneda de provisión; sumar solo dentro de la misma moneda.", "number", "decimal"),
      f("payment_currency", "Moneda de pago", "dimension", "Moneda del pago."),
      f("payment_voucher_number", "Comprobante de pago", "attribute", "Número del comprobante de pago."),
      f("payment_document_number", "Documento de pago", "attribute", "Documento del pago (cheque, transferencia)."),
      f("pay_usd", "Pago USD", "measure", "Pago efectivo en USD.", "number", "usd"),
    ],
    metrics: [
      m("vouchers_count", "Comprobantes", "Número de comprobantes.", "count", "integer"),
      m("pay_usd_total", "Pago USD", "Suma de pagos en USD.", "sum", "usd", { field: "pay_usd" }),
      m("provision_amount_total", "Importe provisionado", "Suma de importes provisionados; válida solo dentro de una misma moneda.", "sum", "decimal", { field: "provision_amount" }),
      m("suppliers_count", "Proveedores", "Proveedores distintos.", "count_distinct", "integer", { field: "ruc" }),
    ...
    rules: [
      "pay_usd es el pago efectivo; provision_amount conserva su moneda y solo se suma dentro de la misma provision_currency.",
      "Para detalle por lote usar traceability_payments; esta fuente responde cuánto se pagó por oficina o proveedor.",
    ],
    defaultDateField: "payment_date",
    keywords: ["pago", "pagos", "comprobante", "provisión", "provision", "proveedor", "oficina", "tesorería", "tesoreria", "desembolso"],
    enabled: true,
    access: { scopes: ["traceability"] },
  },
  {
    ...
    rules: [
      "Las metas se comparan contra traceability_payments agrupando por office_name y mes (V-Ai v1 no cruza fuentes: mostrar ambas en widgets separados).",
      "Sin filtro de período devuelve todos los meses con meta.",
    ],
    defaultDateField: "target_period",
    relations: [{ field: "office_name", source: "traceability_payments", targetField: "office_name", description: "Meta → pagos contables de la oficina." }],
  ...
  },
  {
    ...
    area: "fleet",
    description: "Detalle auditable de todos los vales de abastecimiento con placa normalizada, sede, moneda separada, ficha técnica y exceso por capacidad calculado por vale.",
    endpoint: "/api/vai/fleet/fuel",
    sqlView: "dw.v_dit_vai_flota_combustible",
    ...
    rules: [
      ...
      "total_original conserva la moneda de origen. Usar cost_pen o cost_usd según currency_code; no convertir ni mezclar monedas.",
  ...
  },
  {
    ...
    rules: [
      ...
      "excess_pen y excess_usd permanecen separados por moneda y no se convierten.",
    ],
  ...
  },
  {
    ...
    sqlView: "dw.v_dit_vai_flota_recorridos",
