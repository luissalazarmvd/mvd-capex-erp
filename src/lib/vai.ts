...
const FLEET_FUEL_QUERY = q(["date_cons"], ["plate", "group_name", "brand", "model", "cost_center", "type_fuel", "gas_station", "driver_name"]);
...
const fleetFuelSummarySource = (grain: "day" | "month"): VaiSource => ({
  ...
  endpoint: `/api/vai/fleet/fuel-summary?${grain === "day" ? "grain=day&" : ""}apply_factor=1`,
  ...
  query: q(["period_start"], ["plate", "group_name", "brand", "model", "status_name"]),
...
export const VAI_SOURCES: VaiSource[] = [
  ...
  },
  {
    ...
    query: q(["cal_date"], ["plate", "group_name", "driver_name"]),
    fields: [
      f("gps_identifier", "Identificador GPS", "attribute", "Identificador del equipo GPS."),
  ...
  },
  {
    ...
    endpoint: "/api/vai/fleet/dist-cons-rat",
    sqlView: "dw.v_logistics_flota_dist_cons_rat",
    grain: "Una fila por placa y cal_date.",
    query: q(["cal_date"], ["plate", "group_name", "brand", "model"]),
    fields: [
      f("plate", "Placa", "dimension", "Placa normalizada sin guiones."),
