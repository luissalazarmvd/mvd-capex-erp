...
export type VaiFormat = "integer" | "decimal" | "usd" | "pen" | "percent" | "fraction" | "tmh" | "tms" | "kg" | "oz" | "hours" | "days" | "months" | "km" | "gal" | "km_per_gal" | "l_100km" | "pen_per_km" | "usd_per_km" | "pen_per_gal" | "usd_per_gal" | "grade_oztc" | "grade_gt" | "date" | "text";
...
export const VAI_SOURCES: VaiSource[] = [
    ...
    },
    {
        ...
        area: "planta",
        description: "Balance de planta por guardia (A/B): tonelaje, humedad, leyes de cabeza, gramos alimentados y producidos de Au/Ag, leyes de overflow y relave, recuperación, horas de operación y parada, consumo de NaCN, soda y bolas por molino, y costo prorrateado por guardia.",
    ...
    },
    {
        ...
        area: "refinery",
        description: "Consumo de insumos por campaña de refinería, proceso, subproceso e insumo: cantidad real, consumo óptimo ML, precio unitario logístico y costo USD real y óptimo, con el carbón y el oro de la campaña para ratios.",
...
export const VAI_MAX_FILTERS = 12;
...
export function validateModelOutput(output: VaiModelOutput, userPrompt = "", allowedSourceIds?: string[]): VaiValidation {
    ...
    if (!requestsAllHistory(userPrompt)) {
        ...
        for (const sourceId of sources) {
            ...
            if (!source || (source.temporalMode === "snapshot" && !selected?.explicit) || !field || field.role !== "date")
                continue;
