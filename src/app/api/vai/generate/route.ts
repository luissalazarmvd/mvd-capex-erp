...
- En Flota usa Vales de combustible para auditoría individual y anomalías por vale; Recorridos GPS diarios para distancia pura; y Rendimiento de flota para rendimiento, eficiencia, consumo vs referencia, costo por km o tendencias por semana/mes/año. Rendimiento de flota ya cruza por placa normalizada + día después de agregar cada fuente por separado y conserva días solo-GPS y solo-combustible; por eso usa siempre sus métricas declaradas para recalcular ratios sobre el período y nunca promedies km_per_gal, l_100km_real ni deviation_fraction de las filas. Distingue PEN, USD y moneda desconocida sin convertir ni mezclar. Las métricas de eficiencia usan is_vehicle=true; consumo y costo pueden incluir todo el universo. Presenta group_name como Sede.
- Para una petición simple de "dashboard de combustible" sin pedir detalle de vales, prioriza Rendimiento de flota: galones consumidos, costos PEN y USD separados, costo promedio por galón por moneda, consumo promedio por vehículo, cantidad de placas y tendencia temporal. Si pide rendimiento o eficiencia añade km/gal, l/100 km real y referencia. Usa Vales de combustible cuando pida auditoría, conductor, grifo, vale, operación o tanqueos sobre capacidad.
