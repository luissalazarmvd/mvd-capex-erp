  ...
  return (
    <details className="ti-project" open={open} onToggle={(event) => onToggle(event.currentTarget.open)}>
      <summary>
        ...
        <div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Before · MH/month", "Avant · HP/mois")}</div><div className="ti-summary-value">{number(result.avgBefore, 2)} {tr(lang, "MH/month", "HP/mois")}</div></div>
        <div className="ti-summary-metric"><div className="ti-label">{tr(lang, "After · MH/month", "Après · HP/mois")}</div><div className="ti-summary-value">{number(result.avgCurrent, 2)} {tr(lang, "MH/month", "HP/mois")}</div></div>
        ...
        <div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Annualized USD savings", "Économies USD annualisées")}</div><div className="ti-summary-value">{money(result.avgUsd * 12)}</div></div>
  ...
  return (
    <details className="ti-project" open={open} onToggle={(event) => onToggle(event.currentTarget.open)}>
      <summary>
        ...
        <div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Before · licenses", "Avant · licences")}</div><div className="ti-summary-value">35</div></div>
        ...
        <div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Annualized USD savings", "Économies USD annualisées")}</div><div className="ti-summary-value">{money(24941)}</div></div><div className="ti-chevron">⌄</div>
      </summary>
      <div className="ti-project-body">
...
function ProjectedProject({ definition, lang, open, onToggle, onResult, averageLots, averageCampaigns }: { definition: ProjectedDefinition; lang: Lang; open: boolean; onToggle: (open: boolean) => void; onResult: (key: string, metric: ProjectionMetric) => void; averageLots: number; averageCampaigns: number }) {
  ...
  return (
    <details className="ti-project projected" open={open} onToggle={(event) => onToggle(event.currentTarget.open)}>
      <summary><div className="ti-project-title"><div className="ti-icon">P</div><div><div className="ti-project-name">{tr(lang, definition.titleEn, definition.titleFr)}</div><div className="ti-project-meta">{tr(lang, "Area", "Domaine")}: {tr(lang, definition.areaEn, definition.areaFr)} · Key User: {keyUser}</div><span className={`ti-status ${quantified ? "ok" : "bad"}`}>{quantified ? tr(lang, "Projected assumptions", "Hypothèses projetées") : tr(lang, "Baseline pending", "Référence à définir")}</span></div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Before · MH/month", "Avant · HP/mois")}</div><div className="ti-summary-value">{quantified ? `${number(beforeMonthlyMh, 2)} ${tr(lang, "MH/month", "HP/mois")}` : "—"}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "After · MH/month", "Après · HP/mois")}</div><div className="ti-summary-value">{quantified ? `${number(afterMonthlyMh, 2)} ${tr(lang, "MH/month", "HP/mois")}` : "—"}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Optimization", "Optimisation")}</div><div className="ti-summary-value good">{percent(optimization)}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Annualized USD savings", "Économies USD annualisées")}</div><div className="ti-summary-value">{money(metric.annualUsd)}</div></div><div className="ti-chevron">⌄</div></summary>
...
function MlProject({ rows, lang, open, onToggle, onResult }: { rows: MlRow[]; lang: Lang; open: boolean; onToggle: (open: boolean) => void; onResult: (metric: PotentialMetric) => void }) {
  ...
  return (
    <details className="ti-project potential" open={open} onToggle={(event) => onToggle(event.currentTarget.open)}><summary><div className="ti-project-title"><div className="ti-icon">ML</div><div><div className="ti-project-name">{tr(lang, "ML Refinery Consumption Optimization", "Optimisation ML de la consommation en raffinerie")}</div><div className="ti-project-meta">{tr(lang, "Area", "Domaine")}: {tr(lang, "Refinery", "Raffinerie")} · Key User: Richard Alcocer · GET /api/dti/ref-ml</div><span className={`ti-status ${rows.length ? "ok" : "bad"}`}>{number(rows.length)} {tr(lang, "records", "enregistrements")}</span></div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Before · USD/month", "Avant · USD/mois")}</div><div className="ti-summary-value">{money(avgActual)}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "After · USD/month", "Après · USD/mois")}</div><div className="ti-summary-value">{money(avgModel)}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Optimization", "Optimisation")}</div><div className="ti-summary-value good">{percent(optimization)}</div></div><div className="ti-summary-metric"><div className="ti-label">{tr(lang, "Annualized USD savings", "Économies USD annualisées")}</div><div className="ti-summary-value">{money(metric.annualUsd)}</div></div><div className="ti-chevron">⌄</div></summary>
