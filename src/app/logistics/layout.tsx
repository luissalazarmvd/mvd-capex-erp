...
export default function LogisticsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div data-module="logistics" className="logistics-theme" style={{ minHeight: "100vh", background: "var(--bg)" }}>
      <header
        style={{
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ lineHeight: 1.1 }}>
                <div style={{ fontSize: 19, fontWeight: 500, letterSpacing: "-.01em" }}>MVD – LOGISTICA</div>
