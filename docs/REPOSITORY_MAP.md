...
- Backend/SQL V-Ai externo: misma carpeta `02_SQL`; un solo bloque `(DESDE ACA V-AI)…(HASTA ACA V-AI)` al final de `server.js` (persistencia de dashboards + datasets GET `/api/vai/*`); tabla en `01_Tables/stg_vai_all.sql`.
